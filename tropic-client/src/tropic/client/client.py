...
class TropicClient:
    ...
    ALLOWED_FIELDS: ClassVar[set[str]] = {
        ...
        "parameters__is_experimental__in",
        "parameters__temperature__lte",
        "parameters__temperature__gte",
        "parameters__pressure__lte",
        "parameters__pressure__gte",
        "parameters__monomer_state",
        "parameters__monomer_state__in",
        "parameters__polymer_state",
        "parameters__polymer_state__in",
        "parameters__initiator_smiles",
        "parameters__initiator_smiles__in",
        "parameters__initial_monomer_conc__lte",
        "parameters__initial_monomer_conc__gte",
        "parameters__bulk_monomer_conc__lte",
        "parameters__bulk_monomer_conc__gte",
        "parameters__medium",
        "parameters__medium__in",
        "parameters__solvent",
        "parameters__solvent__in",
        "parameters__cosolvent",
        "parameters__cosolvent__in",
        "parameters__method",
        "parameters__method__in",
        "parameters__functional",
        "parameters__functional__in",
        "parameters__basis_set",
        "parameters__basis_set__in",
        "parameters__dispersion",
        "parameters__dispersion__in",
        "parameters__forcefield",
        "parameters__forcefield__in",
        "parameters__solvent_model",
        "parameters__solvent_model__in",
        "parameters__topology",
        "parameters__topology__in",
