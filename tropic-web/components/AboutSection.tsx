  ...
  return (
    <Stack gap="xl">
      ...
      <Text c="dimmed">
        ...
        Collection) is an open-source database of experimental and computational
        thermodynamic parameters for ring-opening polymerization (ROP)
        reactions. Our goal is to facilitate the data-driven discovery of novel,
        functional polymers that are primed for chemical recycling.
      </Text>
      ...
      <Stack gap="xs">
        ...
        <Text>
          ...
          peer-reviewed academic literature. Each entry is linked to its source
          via a Digital Object Identifier (DOI), allowing for easy access to the
          original publication and its metadata.
        </Text>
        <Text>
          ...
          thermodynamic values. To ensure data quality, we use a flagging system
          to highlight entries that are incomplete or appear inconsistent.
        </Text>
        <Alert
        ...
        >
          ...
          are available to streamline the submission process, helping us quickly
          verify and integrate new information.
        </Alert>
      </Stack>
      ...
      <Stack gap="xs">
        ...
        <Text>
          ...
          parameter for chemical recyclability. It represents the temperature at
          which polymerization and depolymerization are in equilibrium. It is
          derived from the enthalpy (<InlineMath math="\Delta H_p" />) and
            ...
            <Stack>
              ...
              <Card withBorder radius="md">
                ...
                <Text size="sm" mt={5}>
                  ...
                  <InlineMath math="\Delta S_p" /> from the monomer equilibrium
                  concentration at various temperatures, often measured via NMR
                  spectroscopy.
                </Text>
              </Card>
              <Card withBorder radius="md">
            ...
            <Stack>
              ...
              <Card withBorder radius="md">
                ...
                <Text size="sm" mt={5}>
                  ...
                  thermodynamic parameters. The specific <Code>functional</Code>{" "}
                  and
              ...
              <Card withBorder radius="md">
                ...
                <Text size="sm" mt={5}>
                  ...
                  Methods include classical (<Code>ffmd</Code>), ab initio (
                  <Code>aimd</Code>), and machine-learned (<Code>mlmd</Code>)
                  dynamics.
                </Text>
              </Card>
              <Card withBorder radius="md">
                ...
                <Text size="sm" mt={5}>
                  Quantum mechanical methods like <Code>xTB</Code> that offer a
