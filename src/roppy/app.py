...
app = Dash(__name__, 
    external_stylesheets=[dbc.themes.FLATLY, "https://cdn.jsdelivr.net/gh/AnnMarieW/dash-bootstrap-templates/dbc.min.css"],
)
    ...
    html.Div([
        dbc.Row([
            ...
            dbc.Col([
                ...
                html.Div(id='molecule-drawer-output', style={'display': 'none'}),
            ], width="auto"
        ),
                ...
                dbc.Card([
                    ...
                    dbc.CardBody([
                        ...
                        dcc.RangeSlider(
                            ...
                            max=5,
                            step=1,
                            marks={0: "0", 1: "1", 2: "2", 3: "3", 4: "4", 5: "many"},
                            value=[0, 5]
                        ),
                    ])
                ])
            ...
            dbc.Col([
                dash_table.DataTable(
                    ...
                    columns=[
                        ...
                        {'name': 'Ring Size', 'id': 'ring_size', 'type': 'numeric'},
                        {'name': 'Avg ΔH', 'id': 'average_delta_h', 'type': 'numeric'},
                        {'name': 'Avg ΔS', 'id': 'average_delta_s', 'type': 'numeric'}
                    ],
...
async def update_table_async(smiles, ring_size_range):
    ...
    for result in results:
        ...
        structure_cell = f'<img src="data:image/png;base64,{img_data}" style="max-width:150px;">' if img_data else ''
