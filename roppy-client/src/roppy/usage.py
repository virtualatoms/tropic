...
columns = [
    {"title": "Material Id", "selector": "material_id", "sortable": True},
    {
        "title": "Formula",
...
app.layout = html.Div(
        ...
        html.Div(
            [
                html.Span(
                    "Hover me",
                    id="trigger",
                    **{"data-tip": True, "data-for": "tooltip-1"},
                ),
                dash_mp_components.Tooltip("test tooltip", id="tooltip-1"),
            ]
        ),
    ...
    """,
        ...
        dash_mp_components.MaterialsInput(id="materials-input", showSubmitButton=True),
...
@app.callback(
    Output("selected-rows", "children"), Input("search-ui-demo", "selectedRows")
)
